...
$query=mysqli_query($con,"insert into product(proname,procat,proprice,proquant,prodesc,proimg) values('$proname','$procat','$protag','$proprice','$proquant','$prodesc','$proimg')");
	if($query)
	{
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<div class="form-group">
								<select name="procat" class="form-control" required="required">
									...
									<?php $ret=mysqli_query($con,"select * from tag");
										while($row=mysqli_fetch_array($ret))
										{
									?>
									<option value="<?php echo htmlentities($row['tagslug']);?>">
								    	<?php echo htmlentities($row['tagname']);?>
									</option>
									<?php } ?>
